    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/headset.jpg" alt="..." />
                </div>
                <div class="col-md-6">
                    <div class="small mb-1"> H9</div>
                    <h1 class="display-5 fw-bolder">Headset Gamer Fifine H9, Som Surround 7.1, USB, Console e PC,
                        Preto - H9</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">Ótimo Cancelamento De Ruído: Com uma boa quantidade de almofada e um tamanho decente
                        de protetores auriculares, o cancelamento de ruído passivo pode amortecer um pouco o ruído da
                        digitação
                        agressiva do teclado e dos cliques do mouse.</p>
                    <p class="lead"> Conforto De Sobra: Para jogos, não é necessário se esforçar muito para se destacar
                        dos demais. Cuide-se um pouco
                        mais, você pode ficar confortável até a vitória do jogo, ao invés de tirar o fone de ouvido para
                        aliviar a pressão, mas perdendo algumas dicas importantes.</p>
                    <div class="d-flex">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="monitor.php">Comprar</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="placadevideo.php">Comprar</a></div>
                        </div>
                    </div>
                </div>
            </div>
