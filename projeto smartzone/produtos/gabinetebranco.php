...
<head>
    ...
    <title>GABINETE GAMER BRANCO</title>
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/gabinete branco.jpg"
                        alt="..." />
                </div>
                <div class="col-md-6">
                    <div class="small mb-1"> RM-GA-GG-FW</div>
                    <h1 class="display-5 fw-bolder">Gabinete Gamer Rise Mode Galaxy Glass, Mid Tower, Lateral e
                        Frontal em Vidro Temperado, Branco - RM-GA-GG-FW</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">O Gabinete Gamer Rise Mode Galaxy Glass Branco possui design futurista e gamer. Com
                        Lateral e Fronte em Vidro Temperado, tenha maior visibiliade e acesso de todos seus componentes
                        para um visual dinâmico.</p>
                    <p class="lead">Projetado com material de altíssima qualidade, acabamento premium, Lateral e Frontal
                        em Vidro Temperado, layout de fácil instalação e suporte para até 10 fans.</p>
                    <p class="lead">O Gabinete Gamer Rise Mode Galaxy Glass é Construído na cor branca, e suporte para
                        Placa-Mãe ATX, M-ATX e ITX, e placas de vídeo de até 400mm.</p>
                    <div class="d-flex">
