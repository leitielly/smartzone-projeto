    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../assets/monitor.jpg" alt="..." />
                </div>
                <div class="col-md-6">
                    ...
                    <p class="lead">O Monitor Gamer GAMING MG800 34" é um display ultrawide com 34 polegadas, projetado
                        para uma imersão total em jogos. Ele oferece uma resolução alta, cores vibrantes e um tempo de
                        resposta rápido, ideal para gamers que buscam uma experiência visual envolvente e fluida. A
                        curvatura do monitor proporciona um campo de visão mais amplo, aumentando a profundidade e a
                        imersão durante as partidas. Além disso, ele geralmente inclui tecnologias como FreeSync ou
                        G-Sync para reduzir o tearing e o stuttering, garantindo um desempenho gráfico suave.</p>
                    <div class="d-flex">
