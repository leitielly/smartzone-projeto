    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/placa mae asus.jpg"
                        alt="..." />
                </div>
                <div class="col-md-6">
                    ...
                    <p class="lead">Flexibilidade: Controles abrangentes formam a base da série ASUS Prime. A placa-mãe
                        Prime H610 inclui ferramentas flexíveis para ajustar todos os aspectos do seu sistema,
                        permitindo ajustar as configurações de desempenho para combinar perfeitamente com a maneira como
                        você trabalha para maximizar sua produtividade.</p>
                    <p class="lead">A Unidade de Processamento de Energia (EPU) otimiza automaticamente o consumo de
                        energia e maximiza a economia de energia com o modo Away - uma configuração inteligente que cria
                        um cenário de extrema economia de energia desligando controladores I/O não utilizados.</p>
                    <p class="lead">UEFI Bios: A renomada ASUS UEFI BIOS oferece tudo que você precisa para configurar e
                        ajustar seu sistema. Ela oferece opções simplificadas de forma inteligente para iniciantes em PC
                        DIY, bem como recursos abrangentes para veteranos experientes.</p>
                    <p class="lead">Um modo Advanced intuitivo oferecido via UEFI permite que você assuma o controle
                        total. Um recurso de pesquisa integrado facilita a localização de opções e várias funções
                        avançadas permitem que você faça ajustes finos de forma inteligente para que você ajuste o
                        desempenho da maneira que desejar.</p>
                    <p class="lead">A Prime H610M-A D4 oferece dois slots M.2 que suportam velocidades de transferência
                        de dados de até 32 Gbps via PCIe 3.0, permitindo uma inicialização mais rápida e tempos de
                        carregamento do aplicativo com sistema operacional ou unidades de aplicativo.</p>
                    <div class="d-flex">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="amd.php">Comprar</a>
                            </div>
                        </div>
                    </div>
                </div>
