    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/pc completo.jpg" alt="..." />
                </div>
                <div class="col-md-6">
                    <h1 class="display-5 fw-bolder">Computador Bestpc Completo, Intel Core I5, 8GB, SSD 240GB, Windows
                        10 Trial + Monitor 19 Polegadas</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">Projetado para garantir a produtividade no seu dia a dia!</p>
                    <p class="lead">Os Computadores BestPC equipados com processadores Intel Core i5 têm desempenho
                        surpreendente. Execute múltiplas tarefas ao mesmo tempo com fluidez.</p>
                    <p class="lead">Armazene seu conteúdo de estudos, trabalho, fotos e músicas com segurança, no SSD de
                        alta performance. Transfira seus dados facilmente entre dispositivos através da porta USB. A
                        conexão HDMI, possibilita a praticidade de conectar facilmente o seu PC à sua TV ou ao seu
                        Monitor, e obter o máximo de qualidade de imagem e som. Acompanha manual de instrução.</p>
                    <div class="d-flex">
