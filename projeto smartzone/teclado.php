        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item"><a class="nav-link" href="sac.html">FALE CONOSCO</a></li>
        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <h1 class="display-5 fw-bolder">Teclado Mecânico Gamer HyperX Alloy MKW100, RGB, Switch Red, Full Size, US, Preto</h1>
                    <div class="fs-5 mb-5">
                        <span class="text-decoration-line-through">R$555,45</span>
                        <span>R$ 269,99</span>
                    </div>
                    <p class="lead">Teclado HyperX Alloy MKW100, HKBM1-R-EUA/G - 4P5E1AA#ABA:
                        Obtenha uma iluminação radiante e por tecla com efeitos dinâmicos para adicionar um toque de estilo ao seu setup de PC. </p>
                    <p class="lead"> Estrutura em alumínio durável:
                        Com uma estrutura de alumínio sólida, o Alloy MKW100 foi projetado para fornecer estabilidade quando os toques em teclas estiverem a todo vapor.
                        O descanso para pulso removível ajuda a reduzir a fadiga de longas sessões de jogos ou de trabalho. </p>
                    <p class="lead">   Switches à prova de poeira responsivos e confiáveis:
                        Com switches mecânicos à prova de poeira com classificação de até 50 milhões de toques, você usufruirá a confiabilidade duradoura e silenciosa do Alloy MKW100.
                        O conector USB em metal dourado impede a corrosão, enquanto a trança de tecido aumenta a longevidade do cabo para anos de uso confiável.
                        Personalize o show de luz RGB do Alloy MKW100 com o poderoso software HyperX NGENUITY fácil de usar.</p>
                    <div class="d-flex">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <h5 class="fw-bolder">Monitor Gamer KBM! GAMING MG800 34", Ultrawide, 180Hz, QHD, 1ms, DisplayPort e HDMI, Adaptive Sync, 95% SRGB - KGMG80034PT</h5>
