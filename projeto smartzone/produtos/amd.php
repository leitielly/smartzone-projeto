    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/processador amd.jpg"
                        alt="..." />
                </div>
                <div class="col-md-6">
                    <div class="small mb-1">100-100001503WOF</div>
                    <h1 class="display-5 fw-bolder">Processador AMD Ryzen 7 5700X3D, 3.6 GHz, (4.1GHz Max Turbo), Cachê
                        4MB, 8 Núcleos, 16 Threads, AM4 - 100-100001503WOF</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">Arquitetura Zen 3 Refinada: Desfrute de velocidades supersônicas com 8 núcleos e 16
                        threads de processamento, prontos para enfrentar os títulos mais desafiadores. Frequência base
                        de 3,0GHz e boost dinâmico de até 4,1GHz para eliminar qualquer engasgo.</p>
                    <p class="lead">Eficiência Energética sem Abdicar da Potência.
                        Jogue por horas sem se preocupar. O TDP de 105W garante alto desempenho sem consumo excessivo de
                        energia.</p>
                    <div class="d-flex">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="headset.php">Comprar</a></div>
                        </div>
                    </div>
                </div>
