    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/notebook vaio.jpg"
                        alt="..." />
                </div>
                <div class="col-md-6">
                    <h1 class="display-5 fw-bolder">Notebook Vaio FH15, Intel Core I7-13700H, 32GB, SSD 1TB, Geforce RTX
                        3050, Tela 15.6" FULL HD, Shell Efi, Cinza Escuro</h1>
                    <div class="fs-5 mb-5">

                        R$ 6.899,00

                    </div>
                    <p class="lead">O Notebook VAIO® FH15 é a escolha perfeita para quem busca alta performance em suas
                        atividades. Com processador Intel Core i7 de 13ª geração e placa de vídeo Nvidia RTX 3050, você
                        terá potência e produtividade em suas mãos. Além disso, a tela LCD de 15.6" com resolução Full
                        HD e taxa de atualização de 144Hz proporciona
                        uma experiência visual imersiva e excepcional. Com 32GB de memória RAM e 1TB de armazenamento
                        SSD, você terá espaço de sobra para armazenar todos os seus arquivos, programas e projetos. A
                        conexão de Wi-Fi 6 e a porta RJ-45 permitem que você esteja sempre conectado à internet, com
                        alta velocidade de conexão. O resfriamento Thermal Cooling garante que a máquina mantenha a
                        temperatura ideal, mesmo em
                        atividades intensas. Com teclado retroiluminado multicolorido e leitor de cartões, este notebook
                        é a escolha ideal para quem busca flexibilidade e eficiência.</p>
                    <div class="d-flex">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="headsetrosa.php">Comprar</a>
                            </div>
                        </div>
                    </div>
                </div>
