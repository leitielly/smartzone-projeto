    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/cadeira.jpg" alt="..." />
                </div>
                <div class="col-md-6">
                    <div class="small mb-1"> KGCG600PTVM</div>
                    <h1 class="display-5 fw-bolder">Cadeira Gamer KBM! GAMING Tempest CG600, Preta e Vermelho, Com
                        Almofadas, Descanso Para Pernas Retrátil, Reclinável - KGCG600PTVM</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">Conheça a cadeira KBM! GAMING Tempest CG600! Tenha horas incríveis desfrutando seu
                        gameplay de maneira confortável e aconchegante! Feito com espuma de altíssima densidade e PU, a
                        cadeira KBM! GAMING Tempest CG600 possui descanso para os pés, ideal para aquela pausa entre um
                        jogo e outro! Além do design moderno e robusto, a cadeira proporciona ótima performance nas
                        partidas devido a sensação de conforto que é convertida em foco e concentração, tudo que um
                        gamer de verdade precisa para ser o melhor!</p>
                    <p class="lead">Conforto de um assento firme com um apoio para cabeça e almofada para as costas
                        oferecem um conforto prolongado. Muitos benefícios, possibilitando as mais diversas posições
                        para jogo, conforto e descanso. Reclinação em até 180º e apoios de braços que acompanham a
                        reclinação da cadeira, possibilitando as mais diversas posições para jogo, conforto e descanso.
                    </p>
                    <p class="lead">Com a KBM! GAMING Tempest CG600 sinta a liberdade de rodar por aí, com rodízios com
                        perfil esportivo, em PP, que garantem fluidez de movimento. Aproveite ao máximo todos os
                        momentos em sua cadeira KBM! GAMING Tempest CG600, com conforto, fluidez e design que realçam
                        ainda mais seu setup gamer!</p>
                    <div class="d-flex">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="placadevideo.php">Comprar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="ssd.php">Comprar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="notebook.php">Comprar</a></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                    href="gabinetebranco.php">Comprar</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                        ...
                        <p>
                            <a class="text-white" href="#">Hardware</a>
                        </p>
                        <p>
                            <a class="text-white" href="#">Periféricos</a>
                        </p>
                        <p>
                            <a class="text-white" href="#">Computadores</a>
                        </p>
                        <p>
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                        ...
                        <p>
                            <a class="text-white" href="#">Suporte</a>
                        </p>
                    </div>
