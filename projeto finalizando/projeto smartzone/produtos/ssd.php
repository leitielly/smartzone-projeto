    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="../assets/ssd.jpg" alt="..." />
                </div>
                <div class="col-md-6">
                    <div class="small mb-1"> Snv2s/1000g</div>
                    <h1 class="display-5 fw-bolder">SSD 1TB Kingston Nv2, M.2 2280 PCIe, NVMe, Leitura 3500MB/s,
                        Gravação 2100MB/s - Snv2s/1000g</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">Solução de ultima geração: O nv2 pcie 4.0 nvme ssd da kingston é uma solução
                        substancial de armazenamento de última geração alimentada por um controlador gen 4x4 nvme. O nv2
                        oferece velocidades de leitura/gravação de até 3.500/2.100 mb/s com menores requisitos de
                        energia e menor aquecimento para ajudar a otimizar o desempenho do seu sistema e agregar valor
                        sem sacrifícios.</p>
                    <p class="lead">Compacto: O design compacto de face única m.2 2280 expande o armazenamento em até
                        2tb** enquanto economiza espaço para outros componentes, tornando o nv2 ideal para notebooks
                        mais finos, sistemas de formato pequeno e placas-mãe diy. Instalar um ssd disco de estado sólido
                        m.2 é fácil e aumentará significativamente o desempenho do seu computador. Siga esses passos
                        abaixo para acelerar seu dispositivo e aumentar o espaço livre de armazenamento.</p>
                    <p class="lead">Mais armazenamento para você: Disponível em capacidades de 1 tb para oferecer todo o
                        espaço necessário para aplicativos, documentos, fotos, vídeos e muito mais. Integra-se
                        facilmente em modelos com conectores m.2. Perfeito para laptops finos e pcs de formato pequeno.
                    </p>
                    <div class="d-flex">
