...
<head>
    ...
    <title>HEADSET GAMER ROSA</title>
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/headset rosa.jpg" alt="..." />
                </div>
                <div class="col-md-6">
                    <div class="small mb-1">HV-H2002P</div>
                    <h1 class="display-5 fw-bolder">Headset Gamer Havit H2002D, Drivers 53mm, P3, XBOX ONE e PS4, Rosa -
                        HV-H2002P</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">Surpreendente qualidade sonora. Design simples e elegante.</p>
                    <p class="lead">Com revestimento de liga fosca e superfície de plástico estilo piano
                        - À prova de desgaste
                        - Resistente a riscos
                        - Atualizado
                    </p>
                    <p class="lead">Confortável de usar: Os protetores auriculares possuem design over-ear, são feitos
                        de material de couro de proteína respirável e amigo da pele, confortável de usar mesmo por um
                        longo período e tem um bom efeito de isolamento acústico.</p>
