    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="/assets/notebook.jpg" alt="..." />
                </div>
                <div class="col-md-6">
                    <div class="small mb-1"> G15-i1300-A20P</div>
                    <h1 class="display-5 fw-bolder">Notebook Gamer Dell G15 Intel Core i5-13450HX, 8GB RAM, GeForce
                        RTX 3050 6GB, SSD 512GB, 15.6 Full HD 120Hz, Windows 11 Home, Preto - G15-i1300-A20P</h1>
                    <div class="fs-5 mb-5">
                    ...
                    <p class="lead">Intensifique a ação. Com o novo notebook Dell G15 Gaming você terá uma incrível
                        experiência em um notebook com um desempenho excepcional. Este notebook conta com a 13ª geração
                        de processadores Intel Core, que fornecem um desempenho poderoso. As placas gráficas NVIDIA
                        GeForce RTX utilizam a arquitetura NVIDIA Ampere, com novos núcleos RT, núcleos Tensor e
                        multiprocessadores de streaming para recursos gráficos realistas com Ray Tracing.</p>
                    <p class="lead">O G15 Gaming possui teclado em português retroiluminado com iluminação laranja e
                        marcações WASD, perfeito para jogar em ambientes com baixa luminosidade. O design térmico
                        incorpora uma entrada de ar dupla. Esse ar é então expelido por quatro saídas maximizar o fluxo
                        de ar, proporcionando a refrigeração ideal.</p>
                    <p class="lead">Os mais recentes avanços no design térmico proporcionam ao Dell G15 a capacidade de
                        fornecer potência ampla e adaptar-se a uma carga de sistema dinâmica. Assim, os componentes
                        permanecem mais frios, e a velocidade de clock permanece mais alta até na execução dos
                        aplicativos mais exigentes.</p>
                    <div class="d-flex">
