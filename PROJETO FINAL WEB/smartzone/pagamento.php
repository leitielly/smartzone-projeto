    ...
    <header class="bg-black py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p>Adicionar ou Alterar Forma de Pagamento.</p>
            </div>
        </div>
    </header>
    <br><br>
    ...
    <div class="container">
        <div class="section" id="adicionar-pagamento">
            ...
            <div class="instructions">
                ...
                <a class="btn btn-outline-dark mt-auto" href="login.php">Adicionar Pagamento</a>
            </div>
        </div>
        <br>
        <div class="section" id="alterar-pagamento">
            ...
            <div class="instructions">
                ...
                <a class="btn btn-outline-dark mt-auto" href="login.php">Alterar Pagamento</a>
            </div>
        </div>
    </div>
    <br><br>
